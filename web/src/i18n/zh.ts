...
export const zh: Translations = {
  ...
  profiles: {
    ...
    skills: "技能",
    configure: "配置",
    configureTitle: "此 Agent 的模型、供应商与技能",
    noModelSet: "未选择模型",
    changeModel: "更换模型",
    modelSaved: "模型已更新",
    skillsEnabled: "已启用 {enabled} / {total} 个技能",
    noSkillsInstalled: "此配置下尚无技能。",
    skillsOnProfile: "已纳入此 Agent",
    skillsInLibrary: "库中可添加",
    addSkill: "添加",
    removeSkill: "移除",
    skillAdded: "已添加技能",
    skillRemoved: "已从 Agent 移除",
    skillsLibrarySharedDefault:
      "默认 Agent 与技能库共用 ~/.hermes/skills，不能在此做「从库纳入」。请展开子 Agent（如 game-artist）再添加。",
    skillsLibraryAllAdded: "默认技能库里的技能已全部纳入此 Agent。",
    skillsLibraryUnavailable:
      "未加载可添加列表。请用本仓库最新代码重启 hermes dashboard 后强刷页面。",
    rename: "重命名",
    editSoul: "编辑 SOUL.md",
