...
This project is indexed by GitNexus as **hermes-agent-stable** (164494 symbols, 305063 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
