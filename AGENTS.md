...
This project is indexed by GitNexus as **hermes-agent-stable** (155275 symbols, 262976 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
