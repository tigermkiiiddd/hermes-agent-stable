...
This project is indexed by GitNexus as **hermes-agent-stable** (182580 symbols, 351427 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
